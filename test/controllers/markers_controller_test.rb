...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { lat: @marker.lat, lng: @marker.lng, title: @marker.title } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { lat: @marker.lat, lng: @marker.lng, title: @marker.title } }
